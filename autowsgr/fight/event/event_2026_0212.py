"""
舰队问答类活动抄这个
后续做活动地图时截取简单活动页面, 放在event_image, 出击按钮为1.png, 简单活动页面是2.png(活动地图页面上活动的名字)
20260212 换成活动日期
根据活动进入的过程调节_go_map_page 和 _go_fight_prepare_page
"""
...
NODE_POSITION = (
    None,
    (0.178125, 0.20925925925925926),
    (0.384375, 0.2462962962962963),
    (0.9083333333333333, 0.3148148148148148),
    (0.27708333333333335, 0.6259259259259259),
    (0.5364583333333334, 0.40555555555555556),
    (0.6395833333333333, 0.6444444444444445),
)


class EventFightPlan20260212(Event, NormalFightPlan):
    def __init__(
        self,
        timer: Timer,
        plan_path,
    ...
    def _load_fight_info(self):
        self.info = EventFightInfo20260212(self.timer, self.config.chapter, self.config.map)
...
class EventFightInfo20260212(Event, NormalFightInfo):
    def __init__(self, timer: Timer, chapter_id, map_id, event='20260212') -> None:
